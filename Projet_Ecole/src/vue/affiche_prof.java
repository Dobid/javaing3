...
public class affiche_prof extends JFrame {
  ...
  private JTextField prof= new JTextField("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
  private JButton but_prof= new JButton("rechercher prof");
  private JTextField res_prof= new JTextField("rentrer prof");
...
//    top.add(prof);
    top.add(but_prof,BorderLayout.SOUTH);
    top.add(res_prof);
  ...
  class BoutonListener implements ActionListener{
	...
	if(source ==but_prof)
	{
		  ...
		  // si true 
	res_prof.setText("bite");
	res_prof.setBackground(Color.green);
...
if(randi==2) {
	 ...
	 def="age de sa grand mere";
			...
			panel.repaint();
			affiche.setEnabled(false);
			res_prof.setText("rentrer prof");
			res_prof.setBackground(Color.WHITE);
